...
export class DashboardService {
    ...
    constructor(private http: HttpClient,private httpM:Http, private router: Router, private jwtHelper: JwtHelper) { }


    GetOccuMotCle(){
        return this.http.get("http://192.168.43.89:8222/getData/zara/8");
    }

    GetOccType() {
        return this.http.get("http://192.168.43.89:8222/getData/commerce/8");
    }

    GetOccProduit() {
        return this.http.get("http://192.168.43.89:8222/getData/vetements/8");
    }
